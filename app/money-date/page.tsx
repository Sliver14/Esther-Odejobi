...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Bridge by Obsidian, Yaba, Lagos."
    },
    {
      q: "Who should attend?",
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] items-center gap-0 max-w-[1240px] mx-auto w-full px-6 md:px-16 relative z-[15] pt-10 lg:pt-8 pb-4 lg:pb-0">
          <div className="relative z-20 text-center lg:text-left flex flex-col justify-center items-center lg:items-start w-full">
            ...
            <div className="w-full grid grid-cols-3 gap-1 md:gap-3 mb-4 md:mb-6 text-white/90 max-w-2xl bg-white/5 border border-white/10 p-2 md:p-3 rounded-2xl backdrop-blur-md">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-1 md:gap-2">
                ...
                <div className="text-center sm:text-left">
                  <span className="font-extrabold text-[8px] min-[375px]:text-[10px] sm:text-xs block leading-tight">Bridge by Obsidian, Yaba</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl uppercase font-black leading-[1.1] tracking-wide mb-6">
                ...
                <span className="text-gold">WEALTH. WELLNESS. PURPOSE.</span>
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-16 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-extrabold text-base text-[#001333] mb-1">Bridge by Obsidian</h4>
                    <p className="text-slate-600 text-sm">6 University Rd, Onike, Lagos, Nigeria</p>
                  </div>
                </div>
                <div>
                  <h4 className="font-extrabold text-base text-[#001333] mb-1">Access & Arrival</h4>
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Centrally located in Yaba, Bridge by Obsidian provides a premium, modern space easily reached from both the Mainland and Island. We advise arriving by 10:30 AM for registration, verification, and early seat selection.
                  </p>
                </div>
                <div>
            ...
            <div className="relative aspect-video rounded-3xl overflow-hidden border border-slate-200 shadow-xl w-full min-h-[340px] bg-slate-100">
              <iframe
                title="Bridge by Obsidian Location Map"
                src="https://maps.google.com/maps?q=Bridge%20by%20Obsidian,%20Yaba,%20Lagos&t=&z=16&ie=UTF8&iwloc=&output=embed"
      ...
      <section className="relative py-28 overflow-hidden text-center bg-gradient-to-r from-royal-blue-dark to-royal-blue text-white">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto px-6">
          ...
          <p className="text-white/90 text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
            Don’t just make more money. Build a life worth living.
            <br className="hidden sm:inline" />
            <span className="block mt-3 text-white/80 text-base md:text-lg font-medium">
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-16 w-full">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-white/60">
                ...
                >
                  ...
                  <span>Bridge by Obsidian, Yaba, Lagos</span>
                </a>
              </div>
            </div>
          ...
          <div className="border-t border-white/5 py-8 flex flex-col items-center gap-6">
            ...
            <div className="flex justify-center gap-4">
              <a
                href="https://instagram.com/theesther.oj"
                target="_blank"
                rel="noopener noreferrer"
                ...
                title="Follow Instagram @theesther.oj"
              >
              ...
              <a
                href="https://tiktok.com/@theesther.oj"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full border border-white/10 bg-white/5 text-white/80 hover:text-gold hover:border-gold/30 hover:bg-white/10 flex items-center justify-center transition-all duration-300 hover:-translate-y-1 shadow-lg"
                title="Follow TikTok @theesther.oj"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <a
                href="https://www.youtube.com/@theesther_oj"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full border border-white/10 bg-white/5 text-white/80 hover:text-gold hover:border-gold/30 hover:bg-white/10 flex items-center justify-center transition-all duration-300 hover:-translate-y-1 shadow-lg"
                title="Follow YouTube @Money Talk with Esther Odejobi"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
