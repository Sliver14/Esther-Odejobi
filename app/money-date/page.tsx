...
export default function Home() {
  ...
  return (
    <>
      {/* 1. Header/Navbar */}
      <nav
        className={`fixed inset-x-0 top-0 z-[60] flex items-center justify-between px-6 md:px-16 py-4 transition-all duration-300 ${scrolled ? "bg-[#001333] shadow-xl border-b border-royal-blue/10" : "bg-transparent"
          }`}
      >
