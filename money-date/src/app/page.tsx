...
export default function Home() {
  ...
  return (
    <>
      ...
      <header
        id="top"
        className="relative min-h-[100vh] overflow-hidden flex flex-col bg-[radial-gradient(120%_80%_at_78%_-5%,rgba(255,255,255,0.15),transparent_55%),radial-gradient(90%_70%_at_10%_110%,rgba(0,75,183,0.45),transparent_60%),linear-gradient(160deg,#004BB7_0%,#003294_45%,#001C66_100%)] pt-24"
      >
