...
export default function Home() {
  ...
  return (
    <>
      ...
      <header
        id="top"
        className="relative min-h-[100vh] overflow-hidden flex flex-col bg-[radial-gradient(120%_80%_at_78%_-5%,rgba(255,255,255,0.15),transparent_55%),radial-gradient(90%_70%_at_10%_110%,rgba(0,104,74,0.45),transparent_60%),linear-gradient(160deg,#00684A_0%,#004D36_45%,#002A1C_100%)] pt-24"
      >
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] items-center gap-10 max-w-[1240px] mx-auto w-full px-6 md:px-16 relative z-[5] pt-20 md:pt-12">
          <div className="relative z-[6] text-center lg:text-left">
            ...
            <h1 className="text-2xl md:text-[2.8rem] leading-tight uppercase font-black text-white mt-1 mb-4 drop-shadow-[0_15px_30px_rgba(0,0,0,0.3)]">
              Beyond <span className="text-gold">Money:</span> Building a Life <span className="text-gold whitespace-nowrap">That Thrives.</span>
            </h1>

            <p className="text-white/95 text-base md:text-lg font-medium tracking-wide mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Bigger Conversations. Better Connections. Smarter Money Decisions.
              <span className="block mt-2 text-sm text-white/70">A premium biannual financial wellness experience merging wealth creation with intentional living.</span>
            </p>

            {/* Event Info Panel */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 text-white/90 max-w-2xl bg-white/5 border border-white/10 p-4 rounded-2xl backdrop-blur-md">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <span className="font-extrabold text-sm block leading-tight">Saturday, 10th Oct 2026</span>
                  <small className="text-[10px] text-white/60 font-semibold uppercase">Date</small>
                </div>
              </div>
              <div className="flex items-center gap-3 border-t sm:border-t-0 sm:border-x border-white/10 pt-3 sm:pt-0 sm:px-3">
                <div className="w-10 h-10 rounded-xl bg-gold/10 flex items-center justify-center text-gold shrink-0 border border-gold/20">
                  <svg className="w-5 h-5 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="text-left">
                  <span className="font-extrabold text-sm block leading-tight">11:00 AM – 4:00 PM</span>
                  <small className="text-[10px] text-white/60 font-semibold uppercase">Time</small>
                </div>
              </div>
              <div className="flex items-center gap-3 border-t sm:border-t-0 pt-3 sm:pt-0">
                ...
                <div className="text-left">
                  <span className="font-extrabold text-sm block leading-tight">The Zone, Gbagada</span>
                  <small className="text-[10px] text-white/60 font-semibold uppercase">Lagos, Nigeria</small>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 items-center">
              <button
                onClick={() => setModalOpen(true)}
                className="group inline-flex items-center gap-2.5 font-extrabold tracking-wide rounded-full px-8 py-3.5 text-base bg-gold text-[#001333] shadow-[0_12px_25px_-8px_rgba(255,163,0,0.7)] hover:-translate-y-0.5 hover:shadow-[0_18px_35px_-6px_rgba(255,163,0,0.85)] transition-all cursor-pointer"
              >
                Reserve Your Seat
                <span className="transition-transform group-hover:translate-x-1">→</span>
              </button>
              <a
                href="#tickets"
                className="font-bold text-sm text-white/80 hover:text-white border-b border-white/20 hover:border-gold pb-1 transition-all"
              >
                View Ticket Options
              </a>
            </div>
          ...
          <div className="relative self-end h-full min-w-0 flex items-end justify-center lg:justify-end">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {panelists.map((panelist, idx) => (
              <div
                ...
                className="group relative aspect-[4/5] rounded-3xl overflow-hidden bg-gradient-to-b from-[#002A1C]/25 to-[#004D36]/25 border border-white/10 shadow-lg cursor-pointer flex items-center justify-center p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="relative overflow-hidden border border-white/5 bg-white/5 hover:bg-white/10 p-6 pb-14 rounded-2xl transition-all duration-300 isolate">
                <div className="absolute top-0 right-0 w-16 h-16 bg-gold/5 rounded-bl-full pointer-events-none"></div>
                <div className="absolute right-4 top-1 text-7xl md:text-8xl font-black text-white/5 select-none pointer-events-none -z-10">0{idx + 1}</div>
